 ...
 * Purpose: Object-Oriented Programming Concepts
 */
...
static void Main (string[] args)
{
    ...
    // you can access its properties to get/set its value by using the syntax <variable name>.<property>
    ...
    // alternatively, you may use the syntax below, if for some reason your arguemnts are not in the specific sequence 
